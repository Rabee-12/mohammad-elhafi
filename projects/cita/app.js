/* ============================================================================
   ÇİTA Rent a Car — site data + logic (vanilla JS, no build step)
   Edit data here; the page renders from these objects.
   ========================================================================== */

const CONFIG = {
  brand: "ÇİTA Rent a Car",
  /* ÇİTA's WhatsApp / phone number — digits only, country code, no "+"/spaces.
     +90 507 019 61 00. This single value powers every WhatsApp button + form. */
  whatsapp: "905070196100",
  email: "citarentacar@gmail.com",
  addressLine: "Akzambak Sk. No:2, Kayabaşı, 34494 Başakşehir / İstanbul",
  mapsUrl:
    "https://maps.google.com/maps/search/Akzambak%20Sk.%202%2C%2034494%20Istanbul%2C%20Basaksehir%20T%C3%BCrkiye/@41.1206,28.7684,17z?hl=en",
  mapEmbed:
    "https://www.google.com/maps?q=Akzambak%20Sk.%202%2C%2034494%20Ba%C5%9Fak%C5%9Fehir%2C%20%C4%B0stanbul&output=embed",
};

/* Fleet — specs read from ÇİTA's own WhatsApp catalogue cards.
...
const CARS = [
  { id: "chery-tiggo-8-pro", brand: "Chery", model: "Tiggo 8 Pro", cat: "suv", fuel: "gasoline", seats: 7, trans: "automatic", photos: 7, hero: 7 },
  { id: "kia-sportage", brand: "Kia", model: "Sportage", cat: "suv", fuel: "gasoline", seats: 5, trans: "automatic", photos: 5, hero: 1 },
  { id: "peugeot-2008", brand: "Peugeot", model: "2008", cat: "suv", fuel: "gasoline", seats: 5, trans: "automatic", photos: 7, hero: 1 },
  { id: "hyundai-bayon", brand: "Hyundai", model: "Bayon", cat: "suv", fuel: "gasoline", seats: 5, trans: "automatic", photos: 6, hero: 4 },

  { id: "renault-megane", brand: "Renault", model: "Megane", cat: "sedan", fuel: "diesel", seats: 5, trans: "automatic", photos: 4, hero: 3 },
  { id: "skoda-octavia", brand: "Škoda", model: "Octavia", cat: "sedan", fuel: "hybrid", seats: 5, trans: "automatic", photos: 9, hero: 9 },
  { id: "volkswagen-passat", brand: "Volkswagen", model: "Passat", cat: "sedan", fuel: "gasoline", seats: 5, trans: "automatic", photos: 8, hero: 8 },
  { id: "toyota-corolla", brand: "Toyota", model: "Corolla", cat: "sedan", fuel: "diesel", seats: 5, trans: "automatic", photos: 5, hero: 3 },
  { id: "toyota-corolla-hybrid", brand: "Toyota", model: "Corolla Hybrid", cat: "sedan", fuel: "hybrid", seats: 5, trans: "automatic", photos: 7, hero: 6 },
  { id: "honda-civic", brand: "Honda", model: "Civic", cat: "sedan", fuel: "diesel", seats: 5, trans: "automatic", photos: 6, hero: 6 },
  { id: "honda-city", brand: "Honda", model: "City", cat: "sedan", fuel: "gasoline", seats: 5, trans: "automatic", photos: 8, hero: 1 },
  { id: "hyundai-elantra", brand: "Hyundai", model: "Elantra", cat: "sedan", fuel: "gasoline", seats: 5, trans: "automatic", photos: 7, hero: 4 },
  { id: "renault-taliant", brand: "Renault", model: "Taliant", cat: "sedan", fuel: "gasoline", seats: 5, trans: "automatic", photos: 5, hero: 2 },

  { id: "hyundai-i20", brand: "Hyundai", model: "i20", cat: "economy", fuel: "gasoline", seats: 4, trans: "automatic", photos: 6, hero: 5 },
  { id: "renault-clio", brand: "Renault", model: "Clio", cat: "economy", fuel: "gasoline", seats: 4, trans: "automatic", photos: 5, hero: 5 },
  { id: "kia-picanto", brand: "Kia", model: "Picanto", cat: "economy", fuel: "gasoline", seats: 4, trans: "automatic", photos: 4, hero: 3 },
];
...
const I18N = {
  tr: {
    ...
    "hero.sub": "ÇİTA Rent a Car ile İstanbul'da konforlu, güvenli ve uygun araç kiralama. 7/24 WhatsApp desteği, havalimanı teslimatı ve geniş araç filosu.",
    ...
    "why.title": "Neden ÇİTA Rent a Car?", "why.sub": "Güveninizi kazanmak için çalışıyoruz.",
    ...
    "wa.greet": "Merhaba ÇİTA Rent a Car 👋, araç kiralamak istiyorum.",
    "wa.carMsg": "Merhaba ÇİTA Rent a Car 👋, {car} kiralamak istiyorum. Müsait mi ve fiyatı nedir?",
    "wa.formMsg": "Merhaba ÇİTA Rent a Car 👋\nİsim: {name}\nTelefon: {phone}\nAraç: {car}\nAlış: {pickup}\nİade: {dropoff}\nNot: {note}",
  ...
  en: {
    ...
    "hero.sub": "Comfortable, safe and affordable car rental across Istanbul with ÇİTA Rent a Car. 24/7 WhatsApp support, airport delivery and a wide fleet.",
    ...
    "why.title": "Why ÇİTA Rent a Car?", "why.sub": "We work to earn your trust.",
    ...
    "wa.greet": "Hello ÇİTA Rent a Car 👋, I'd like to rent a car.",
    "wa.carMsg": "Hello ÇİTA Rent a Car 👋, I'd like to rent the {car}. Is it available and what's the price?",
    "wa.formMsg": "Hello ÇİTA Rent a Car 👋\nName: {name}\nPhone: {phone}\nCar: {car}\nPick-up: {pickup}\nDrop-off: {dropoff}\nNote: {note}",
  ...
  ar: {
    ...
    "hero.sub": "تأجير سيارات مريح وآمن وبأسعار مناسبة في إسطنبول مع ÇİTA Rent a Car. دعم على مدار الساعة عبر واتساب، توصيل للمطار وأسطول واسع.",
    ...
    "why.title": "لماذا ÇİTA Rent a Car؟", "why.sub": "نعمل لكسب ثقتك.",
    ...
    "wa.greet": "مرحباً ÇİTA Rent a Car 👋، أريد استئجار سيارة.",
    "wa.carMsg": "مرحباً ÇİTA Rent a Car 👋، أريد استئجار {car}. هل هي متاحة وما السعر؟",
    "wa.formMsg": "مرحباً ÇİTA Rent a Car 👋\nالاسم: {name}\nالهاتف: {phone}\nالسيارة: {car}\nالاستلام: {pickup}\nالإرجاع: {dropoff}\nملاحظة: {note}",
...
/* ----------------------------------------------------------------------------
   State + helpers
   -------------------------------------------------------------------------- */
let LANG = localStorage.getItem("cita-lang") || "tr";
let FILTER = "all";
...
function setLang(lang) {
  LANG = lang;
  localStorage.setItem("cita-lang", lang);
  applyI18n();
  renderFleet();
  renderCarSelect();
